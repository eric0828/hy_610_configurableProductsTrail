...
public class CheckboxProductConfigurationMergeStrategy implements ProductConfigurationMergeStrategy
{
    ...
    {
        final List<String> formLabels = baseConfiguration.stream()
	...
	{
		configurationInfoData.setConfigurationValue(Boolean.valueOf(
				CHECKBOX_CHECKED_VALUE.equals(configurationInfoData.getConfigurationValue())).toString());
	}
}